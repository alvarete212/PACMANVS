var PACMAN2 = function (key,game,startpos){
    ...
    PACMAN2.prototype.updateCounter = function() {
        
            this.tiempo++;
        
    };
    
    PACMAN2.prototype.volver = function(){
    ...
    PACMAN2.prototype.atacar = function(){
    ...
    PACMAN2.prototype.mover = function (direccion) {
        ...
        //  Reset the scale and angle (PACMAN2 is facing to the right in the sprite sheet)
    ...
    PACMAN2.prototype.update = function() {
    ...
    PACMAN2.prototype.comerDot = function(PACMAN2,dot){
    ...
    PACMAN2.prototype.comerPill = function(PACMAN2, pill){
    ...
    PACMAN2.prototype.girar = function(){
    
        var sx = Math.floor(this.sprite.x);
        var sy = Math.floor(this.sprite.y);
    
        //Tenemos que tener en cuenta que, debido al rápido movimiento de PACMAN2, deberemos tener cuidado, porque muchas veces
        //entre la pulsación y cuando se puede realizar el giro, PACMAN2 ya puede haber pasado la zona de giro.
        ...
        //Tenemos que alinear el grid donde nos movemos con las posiciones del sprite de PACMAN2
    ...
    PACMAN2.prototype.comprobarDireccion = function(girarA){
